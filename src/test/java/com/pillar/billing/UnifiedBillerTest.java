...
public class UnifiedBillerTest {
    ...
    @Test
    public void mailInvoiceToCustomersThatHaveAnOustandingBalanceThatDoNotWantEmails(){
    ...
    @Test
    public void mailOrEmailInvoiceToCustomersThatHaveAnOustandingBalances(){
        when(firstCustomer.shouldEmail()).thenReturn(true);
        when(secondCustomer.shouldEmail()).thenReturn(false);
